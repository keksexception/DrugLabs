...
public class NBTTagManager_v1_10_R1 {
	
	private ItemStack stack;
	public NBTTagManager_v1_10_R1(ItemStack stack) {
		this.stack = stack;
	}
	...
	public ItemStack setNBT(String key, String write) {
		...
		net.minecraft.server.v1_10_R1.ItemStack st = CraftItemStack.asNMSCopy(stack);
		st.setTag(tag);
